		...
		<li class="delevery_cont">
			...
			<div class="delevery_info">
				...
				<c:if test="${!empty user  }">
					<div class="input_area"> <input type="number" pattern="\d" value="${user.phone }" name="phone" readonly required onkeypress="return lenthCheck(this, 11)" autocomplete="off" > </div>
				</c:if>
